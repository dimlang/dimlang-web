    ...
    <section className="sectionPadding bg-[#050505] py-24 px-6">
      <div className="container">
        ...
        >
          ...
          >
            <div className="col-span-full h-[400px] relative">
            ...
            <div className="col-span-full md:col-span-3 h-[400px] text-black relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[250px] before:bg-gradient-to-b before:from-[#F0C09A] before:to-transparent before:blur-[2px] before:pointer-events-none before:z-10">
              <div className="absolute top-8 left-8 z-10">
                <h4 className="text-3xl font-semibold mb-1">
            ...
            <div className="col-span-full md:col-span-2 h-[400px] relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[250px] before:bg-gradient-to-b before:from-[#407df7] before:to-transparent before:blur-[2px] before:pointer-events-none before:z-10">
              <div className="absolute top-8 left-8 z-10">
                <h4 className="text-3xl font-semibold mb-1">
            ...
            <div className="col-span-full grid grid-cols-2 gap-6">
              <div className="col-span-full md:col-span-1 h-[400px] relative">
                <div className="absolute top-8 left-8 z-10">
                  <h4 className="text-3xl font-semibold mb-1">
              ...
              <div className="col-span-full md:col-span-1 h-[400px] relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-[250px] before:bg-gradient-to-b before:from-[#6D93DC] before:to-transparent before:blur-[2px] before:pointer-events-none before:z-10">
                <div className="absolute top-8 left-8 z-10">
                  <h4 className="text-3xl font-semibold mb-1">
                    Micro-Agencies
                  </h4>
